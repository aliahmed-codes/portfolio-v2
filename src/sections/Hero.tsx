...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    if (!section || !name || !tagline || !subtitle || !cta || !scrollIndicator) return;
  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative z-10 text-center">
        ...
        <p
          ref={subtitleRef}
          className="text-[#9CA3AF] text-lg sm:text-xl lg:text-2xl max-w-2xl mx-auto mb-4"
        >
          I build digital experiences that matter.
        </p>

        {/* Role */}
        <p className="font-mono text-[#6B7280] text-sm sm:text-base tracking-wider mb-12">
      ...
      >
        <span className="font-mono text-xs text-[#6B7280] tracking-widest">SCROLL</span>
